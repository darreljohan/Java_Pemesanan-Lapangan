...
import Controller.ControllerUserLog;
...
public class UserLog extends javax.swing.JFrame {
     ...
     */
    ControllerUserLog con;
    public UserLog() {
        initComponents();
        con = new ControllerUserLog(this);
        this.BayarLunasButton.setEnabled(false);
    }
    ...
    private void initComponents() {
        ...
        TableLog.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Transaksi", "Nama Lapangan", "Jadwal Pesan", "Jadwal Selesai", "Status "
            }
        ) {
        ...
        if (TableLog.getColumnModel().getColumnCount() > 0) {
            TableLog.getColumnModel().getColumn(0).setPreferredWidth(15);
            TableLog.getColumnModel().getColumn(2).setPreferredWidth(90);
            TableLog.getColumnModel().getColumn(3).setPreferredWidth(90);
            TableLog.getColumnModel().getColumn(4).setPreferredWidth(30);
        }

        judulLabel.setText("CATATAN TRANSAKSI -");
        ...
        jLabel2.setText("- Dapat memilih baris untuk dilunaskan pembayarannya");
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addComponent(BayarLunasButton, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(8, 8, 8))
    ...
    private void TableLogMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TableLogMouseClicked
       ...
       con.getTransaksiByRow(this.getTableLog().getSelectedRow());
    ...
    public void setTableLog(JTable TableLog) {
        this.TableLog = TableLog;
    }

    public JLabel getJudulLabel() {
        return judulLabel;
    }

    public void setJudulLabel(JLabel judulLabel) {
